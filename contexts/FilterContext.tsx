...
export const FilterProvider: React.FC<{ children: ReactNode }> = ({
  ...
  const value = {
    ...
    setStagedOrder: (order: string) =>
      setStagedFilters((f) => ({ ...f, order })),
    stagedCategory: stagedFilters.category,
    setStagedCategory: (category: string) =>
      setStagedFilters((f) => ({ ...f, category })),
    stagedDuration: stagedFilters.duration,
    setStagedDuration: (duration: [number, number]) =>
      setStagedFilters((f) => ({ ...f, duration })),
    applyFilters,
    resetFilters,
  };
