...
const VideoContent: React.FC = () => {
    ...
    const fetchVideos = useCallback(async (currentParams: CurrentFilterParams, query: string, currentPage: number) => {
        setIsLoading(true);
        setError(null);
        try {
    ...
    }, [searchQuery, order, category, duration, viewMode, fetchVideos]);
    ...
    const handleToggleFavoritesView = () => {
        setViewMode(prevMode => (prevMode === 'favorites' ? 'search' : 'favorites'));
    };
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans">
            ...
            <main className="container mx-auto px-4 py-8 pt-20 md:pt-24">
                <div key={viewMode} className="animate-fade-in">
                    <VideoGrid
                        ...
                        lastVideoElementRef={isFavoritesView ? undefined : lastVideoElementRef}
            ...
            {selectedVideo && 
                ...
                />}
            <FloatingActionButton onClick={() => setIsChatbotOpen(!isChatbotOpen)} isOpen={isChatbotOpen} />
